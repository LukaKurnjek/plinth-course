...
compiled code and parameterize the code with the transaction hash and output index of the UTXO we
...
* Digital collectibles and credentials. NFTs(((NFT))) can represent ownership of digital
