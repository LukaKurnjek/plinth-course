...
https://github.com/input-output-hk/mastering-cardano/blob/main/chapters/chapter-08-writing-smart-contracts-plutusv3.adoc#cardano-security[Cardano security].
...
https://meshjs.dev/apis/txbuilder/minting#minting-assets-with-cip-68-metadata-standard[MeshJS docs]
