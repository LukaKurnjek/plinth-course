...
https://github.com/input-output-hk/plutus-pioneer-program/tree/fourth-iteration[fourth iteration]
...
interface that works directly with the Plutus Core [purple]#Data#
type under the hood. Due to Plutus updates, data types can now be thin wrappers
over the [purple]#BuiltinData#
